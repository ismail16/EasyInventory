                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="date" type="text" class="form-control-sm w-100 w-100">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                        ...
                                        <div class="table-responsive" style="margin-top: 10px">
                                            <table class="table table-bordered table-sm table-hover" id="normalinvoice">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <input id="add_invoice_item" class="btn btn-info btn-sm" onclick="add_row('add_row_to_invoice');" value="Add New Item" tabindex="5" type="button">
                                                    </td>
