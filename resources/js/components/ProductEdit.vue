                        ...
                        <div class="card-header pb-0">
                          <div class="row">
                            <div class="col-md-3 float-left">
                                <p><a href="/">Home</a> / Add New Product</p>
                          </div>
                          <div class="col-md-6">
                ...
                <div class="card-body" style="background-color: #f6f6f7;">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="warehouse_id" class="col-sm-3 form-control-label">Sell Price </label>
                                        <div class="col-sm-9">
                                           <input type="" name="" v-model="form.sell_price" class="form-control-sm w-100 w-100">
                                        </div>
                                    </div>
                                </div>    
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">                                      
                                            <datetime format="DD/MM/YYYY h:i:s" v-model="form.mfg_date" autocomplete="off"></datetime>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">                                      
                                            <datetime format="DD/MM/YYYY h:i:s" v-model="form.exp_date"  autocomplete="off"></datetime>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="file" :src="form.image" @change="uploadImage" class="form-control-sm w-100 w-100"/>
                                        </div>
