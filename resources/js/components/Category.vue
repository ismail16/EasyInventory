                        ...
                        <div class="card-header pb-0">
                            <div class="row">
                                <div class="col-md-3 float-left">
                                    <p><router-link to="/dashboard"> Home </router-link> / Category</p>
                                </div>
                                <div class="col-md-6">
                    ...
                    <form @submit.prevent="editMode? updateCategory() : addNewCategory()">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                placeholder="Category Name" class="form-control" :class="{ 'is-invalid': form.errors.has('category_name') }" required>
