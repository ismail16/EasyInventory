                                ...
                                <table class="table table-bordered table-sm table-hover" id="normalExpense">
                                    ...
                                    <tbody id="add_row_to_Expense">
                                        <tr v-for="(expense, index) in form.expenses">
                                            ...
                                            <td class="text-center">
                                                <input class="form-control-sm w-100  text-center" :value="expense.expense_quantity * expense.expense_amount" type="number" disabled>
                                            </td>
                                    ...
                                    <tfoot>
                                        <tr id="appssss">
                                            ...
                                            <td class="text-center">
                                                <input class="form-control-sm text-center w-100" v-model="expense_total_amount" type="number" disabled>
                                            </td>
                                            <td align="center">
